...
func (r *ginController) runProductDeleteHandler() gin.HandlerFunc {

	type InportRequest = runproductdelete.InportRequest
	type InportResponse = runproductdelete.InportResponse
