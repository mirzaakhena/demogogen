...
func (r *ginController) getOneProductHandler() gin.HandlerFunc {

	type InportRequest = getoneproduct.InportRequest
	type InportResponse = getoneproduct.InportResponse
